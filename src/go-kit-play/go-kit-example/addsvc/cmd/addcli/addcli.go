...
/*
➜ /Users/flower/workspace/goDemo/src/go-kit-example/addsvc/cmd/addsvc git:(master) ✗ >./addsvc
ts=2018-11-01T12:47:44.482443462Z caller=addsvc.go:193 transport=debug/HTTP addr=:8080
ts=2018-11-01T12:47:44.482485968Z caller=addsvc.go:290 transport="JSONRPC over HTTP" addr=:8084
ts=2018-11-01T12:47:44.482549926Z caller=addsvc.go:250 transport=Thrift addr=:8083
ts=2018-11-01T12:47:44.482402261Z caller=addsvc.go:207 transport=HTTP addr=:8081
^[[Bts=2018-11-01T12:49:32.07364833Z caller=middleware.go:28 method=Sum a=1 b=2 v=3 err=null
ts=2018-11-01T12:49:32.073834731Z caller=middleware.go:37 method=Sum transport_error=null took=327.218µs
ts=2018-11-01T12:49:50.915247755Z caller=middleware.go:35 method=Concat a=a b=b v=ab err=null
ts=2018-11-01T12:49:50.915287074Z caller=middleware.go:37 method=Concat transport_error=null took=46.437µs
*/

/*
➜  ✗ >./addcli -http-addr=:8081 -method=sum 1 2
1 + 2 = 3
➜  ✗ >./addcli -http-addr=:8081 -method=concat a b
"a" + "b" = "ab"
*/
